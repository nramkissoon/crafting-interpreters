...
static uint8_t makeConstant(Value value) {
  ...
  // return the index in the constant array in the chunk
...
static void forStatement() {
  // a for statement declares a variable, that variable should be scoped to the loop body, create new scope
  beginScope();
